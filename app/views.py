...
SECTION_ARTICLE_ROUTE = "%s/<string:article_slug>" % (ARTICLES_ROUTE)

ALL_ARTICLES_ROUTE = "/articles"

@app.route(SECTION_ROUTE)
...
@app.route(SECTION_ARTICLES_ROUTE , defaults={'article_slug': None})
@app.route(SECTION_ARTICLE_ROUTE)
